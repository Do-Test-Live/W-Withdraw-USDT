            ...
            <div class="row invoice-card-row">
                <?php if (isset($_GET['todayCheck'])) {
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Stake Filter</h4>
                            </div>
                            <div class="card-body">
                                <div class="basic-form">
                                    <form action="Stake-CNY" method="get">
                                        <div class="mb-3 row">
                                        ...
                                        <div class="mb-3 row">
                                            <div class="col-sm-6 mx-auto">
                                                <button type="submit" class="btn btn-primary w-25" name="stakeRecord">
                                                    Show Record
                                                </button>
                                            </div>
                                        </div>
                    ...
                    <?php
                    if (isset($_GET['stakeRecord'])) {
                        $date = $_GET['date'];
                        ?>
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Staking HKD filter by <?php echo $_GET['date']; ?></h4>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="example4" class="display" style="min-width: 845px">
                                            ...
                                            for ($i = 0; $i < $row_count; $i++) {
                                                ...
                                                $end = date('Y-m-d', strtotime($cny_data[$i]["inserted_at"] . ' + ' . $cny_data[$i]["staking_days"] . ' days'));
