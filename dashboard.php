    ...
    <div class="content-body">
        ...
        <div class="container-fluid">
            <div class="row invoice-card-row">
                ...
                <div class="col-lg-6 col-sm-12">
                    <a href="Deposit-CNY?todayCheck=0">
                            ...
                            <div class="card-body d-flex">
                                ...
                                <div>
                                    <h2 class="text-white invoice-num">
                                        ...
                                        $row_count = $db_handle->numRows("SELECT * FROM balance where balance_type='Deposit' and inserted_at like '$today';");
                        ...
                        <div class="card-body d-flex">
                            ...
                            <div>
                                <h2 class="text-white invoice-num">
                                    ...
                                    $data = $db_handle->runQuery("SELECT * FROM balance;");
                                    ...
                                    for ($i = 0; $i < $row_count; $i++) {
                                        if ($data[$i]['balance_type'] == 'Deposit') {
                                            $d_usdt = $data[$i]['balance'] / $data[$i]['conversion_rate'];
                                            $total += $d_usdt;
                                        } else if ($data[$i]['balance_type'] == 'Withdraw') {
                                            $d_usdt = $data[$i]['balance'];
                                            $total -= $d_usdt;
                                        }
                                ...
                                <span class="text-white fs-18">Total HKD Balance</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card bg-secondary invoice-card">
                        <div class="card-body d-flex">
                            ...
                            <div>
                                ...
                                <span class="text-white fs-18">HKD Total withdrawal</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-sm-12">
                    <a href="Stake-CNY?todayCheck=0">
                                ...
                                <div>
                                    <h2 class="text-white invoice-num">
                                        ...
                                        for ($i = 0; $i < $row_count; $i++) {
                                            ...
                                            if ($data[$i]["status"] == 'Pending' && $days >= 7 && ($data[$i]['staking_days'] - $days) == 0) {
                                    ...
                                    <span class="text-white fs-18">Need Withdraw today</span>
                                </div>
                            </div>
                        </div>
                    </a>
                        ...
                        <div class="card bg-success invoice-card">
                            <div class="card-body d-flex">
                                ...
                                <div>
                                    ...
                                    <span class="text-white fs-18">Need Withdraw tomorrow</span>
                                </div>
                            </div>
                        </div>
                    </a>
